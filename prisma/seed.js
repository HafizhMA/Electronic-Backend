...
async function main() {
  ...
  const userId = "8acd90b1-dc6a-4e93-8b47-cda8aa6c94bf";
  ...
  if (existingUser) {
    await prisma.product.createMany({
      data: [
        {
          namaBarang: "Camera Mafia Elektronik",
        ...
        {
          namaBarang: "Handphone Mafia Elektronik",
        ...
        {
          namaBarang: "Keyboard Mafia Elektronik",
        ...
        {
          namaBarang: "Laptop Mafia Elektronik",
        ...
        {
          namaBarang: "Monitor Mafia Elektronik",
        ...
        {
          namaBarang: "Mouse Mafia Elektronik",
